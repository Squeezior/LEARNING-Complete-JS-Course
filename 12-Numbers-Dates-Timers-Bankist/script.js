...
console.log(Number.isFinite(20)); // isFinite - best way of checking if the value is a number
...
const randomInt = (min, max) =>
  Math.floor(Math.random() * (max - min) + 1) + min; // general random function between min and max values
...
console.log(Math.floor('23.9')); //also does type coercion

console.log(Math.trunc(-23.3));
// trunc and floor works the same for positive numbers
console.log(Math.floor(-23.3));

// Rounding decimals

console.log((2.7).toFixed(0)); // always returns a string, js does boxing (primitive -> object -> primitive)
...
console.log(5464798321658489321894893204989865n);
console.log(BigInt(546479832));

// Operations
console.log(10000n + 10000n);
console.log(103425547624133463462432423423425n * 1123123123n);
// console.log(Math.sqrt(16n));

const huge = 34623984815562313125654n;
const num = 23;
...
/////////////////////////////////////////////////////
// Internalizating Dates (Intl)

/////////////////////////////////////////////////////
// Internalizating Numbers (Intl)
/*
